...
public class TestConfiguration {
    ...
    private static void feedAutomaton() {
        ...
        automaton.registerTransition(State.S2, Event.CB2, State.S3);
        automaton.registerTransition(State.S3, Event.CB3, State.S4);
        automaton.registerTransition(State.S4, Event.CB4, State.S1);
