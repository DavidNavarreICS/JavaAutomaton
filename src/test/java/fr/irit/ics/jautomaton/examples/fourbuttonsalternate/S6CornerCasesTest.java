...
public class S6CornerCasesTest extends AbstractCornerCasesTest {

    @Parameterized.Parameters(name = "{index}: trigger event {0} in state S6")
    ...
    public void putInCorrectState() {
        ...
        automaton.acceptEvent(Event.CB4);
    }
